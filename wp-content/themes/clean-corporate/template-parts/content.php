...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php $archive_layout = clean_corporate_get_option( 'archive_layout' ); ?>
	<?php if ( has_post_thumbnail() ) : ?>
		<?php
		$archive_image           = clean_corporate_get_option( 'archive_image' );
		$archive_image_alignment = clean_corporate_get_option( 'archive_image_alignment' );
		?>
		...
		<div class="entry-content">
			...
			<?php if ( 'full' === $archive_layout ) : ?>
				...
				the_content( sprintf(
					...
					wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'clean-corporate' ), array( 'span' => array( 'class' => array() ) ) ),
