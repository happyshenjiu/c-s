		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php _e( 'Upload', 'clean-corporate' ); ?>" data-uploader_title="<?php _e( 'Select Image', 'clean-corporate' ); ?>" data-uploader_button_text="<?php _e( 'Choose Image', 'clean-corporate' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo _x( 'X', 'Remove Button', 'clean-corporate' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
