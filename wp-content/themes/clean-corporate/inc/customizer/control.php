 ...
 */
class Clean_Corporate_Heading_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Clean_Corporate_Message_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Clean_Corporate_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Clean_Corporate_Customize_Section_Upsell extends WP_Customize_Section {
