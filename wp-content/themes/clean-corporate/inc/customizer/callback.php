...
if ( ! function_exists( 'clean_corporate_is_featured_slider_active' ) ) :
	 ...
	 */
	function clean_corporate_is_featured_slider_active( $control ) {
...
if ( ! function_exists( 'clean_corporate_is_featured_slider_active_non_demo' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function clean_corporate_is_featured_slider_active_non_demo( $control ) {
...
if ( ! function_exists( 'clean_corporate_is_featured_slider_active_non_demo_non_image' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function clean_corporate_is_featured_slider_active_non_demo_non_image( $control ) {
...
if ( ! function_exists( 'clean_corporate_is_featured_page_slider_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function clean_corporate_is_featured_page_slider_active( $control ) {
...
if ( ! function_exists( 'clean_corporate_is_featured_post_slider_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function clean_corporate_is_featured_post_slider_active( $control ) {
...
if ( ! function_exists( 'clean_corporate_is_featured_image_slider_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function clean_corporate_is_featured_image_slider_active( $control ) {
...
if ( ! function_exists( 'clean_corporate_is_featured_category_slider_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function clean_corporate_is_featured_category_slider_active( $control ) {
...
if ( ! function_exists( 'clean_corporate_is_featured_tag_slider_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function clean_corporate_is_featured_tag_slider_active( $control ) {
...
if ( ! function_exists( 'clean_corporate_is_image_in_archive_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function clean_corporate_is_image_in_archive_active( $control ) {
...
if ( ! function_exists( 'clean_corporate_is_image_in_single_active' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function clean_corporate_is_image_in_single_active( $control ) {
