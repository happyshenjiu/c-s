 ...
 * @since 1.0.0
 */
class Clean_Corporate_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'clean_corporate';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'clean-corporate' ), $i ),
...
// Initialize.
$clean_corporate_footer_widgets = new Clean_Corporate_Footer_Widgets();
